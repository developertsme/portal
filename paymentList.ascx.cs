...
public partial class components_paymentList : System.Web.UI.UserControl
{
    ...
    {
        SqlCommand cmd = new SqlCommand("select top 100 * from view_payments order by id desc");
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select top 100 * from view_payments where account_name like '%'+@search+'%' or account_email like '%'+@search+'%' order by id desc");
