...
public partial class components_list_stocks : System.Web.UI.UserControl
{
    ...
    {
        SqlCommand cmd = new SqlCommand("select top 100 * from view_stocklist order by id desc");
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select top 100 * from view_stocklist where id like '%'+@search+'%' or  name like '%'+@search+'%' order by id desc");
