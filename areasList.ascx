<%@ Control Language="C#" AutoEventWireup="true" CodeFile="areasList.ascx.cs" Inherits="components_areasList" %>
    ...
    <div class="animated fadeIn">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-edit"></i>Country/Container Area List
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                        ...
                        <table class="table table-responsive-sm table-striped table-sm" data-toggle="table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-sortable="true">Area Type</th>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><a class="btn btn-success" href="website.aspx?page=view_brands&id=<%# Eval("uid")%>"><i class="fa fa-search-plus"></i></a></td>
                        </tr>
                    </ItemTemplate>
