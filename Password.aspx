...
<html lang="en">
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                <a class="" href="https://tsume-art.com" style="mso-line-height-rule:
 ...
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #f57153; font-weight: normal; text-decoration: none" target="_blank" title="">
                                    <img align="center" alt="Forgot your password?" class="mcnImage" src="/images/tsume.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
 ...
 padding-bottom: 9px; padding-left: 18px;' valign="top">Not to worry, we got you! Let’s get you a new password.
                                <br>
<asp:Literal ID="txterror" runat="server"></asp:Literal></br>
                              </td>
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                ...
                                <asp:TextBox ID="loginemail" runat="server" Style="background: #fff;
    border: 1px solid #F3F3F3; border-radius: 4px;display: block; margin: 0 0 2px 0; padding: 7px; font-size: 16px;
    position: relative; width: 100%;" placeholder="Your Registered Email"></asp:TextBox>
 ...
 font-family: 'Asap', Helvetica, sans-serif; font-size: 16px; padding-top:24px;
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                        <asp:LinkButton ID="LinkButton1" CssClass="mcnButton" style="mso-line-height-rule: exactly;
 ...
 #FFFFFF; text-transform:uppercase;" runat="server" OnClick="Button1_Click">Reset password</asp:LinkButton>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding-right: 0px;
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                  <a href="/">Login to Portal</a><br /><br />
                              </td>
                            </tr>
                          </tbody>
                        </table>
