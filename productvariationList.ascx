<%@ Control Language="C#" AutoEventWireup="true" CodeFile="productvariationList.ascx.cs" Inherits="components_productvariationList" %>
    ...
    <div class="animated fadeIn">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-edit"></i>Product Variation List
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%# Eval("depth")%></td>
                            <td><%# Eval("height")%></td>
                            <td><a class="btn btn-success" href="website.aspx?page=view_productvariation&id=<%# Eval("uid")%>"><i class="fa fa-search-plus"></i></a></td>
                        </tr>
                    </ItemTemplate>
