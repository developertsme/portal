...
public partial class components_orderList : System.Web.UI.UserControl
{
    ...
    {
        SqlCommand cmd = new SqlCommand("select top 100 * from view_orders order by id desc");
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select top 100 * from view_orders where id like '%'+@search+'%' or  reference like '%'+@search+'%' order by id desc");
