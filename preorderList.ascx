<%@ Control Language="C#" AutoEventWireup="true" CodeFile="preorderList.ascx.cs" Inherits="components_preorderList" %>
        ...
        <div class="card">
            <div class="card-body p-0 d-flex align-items-center">
                ...
                <div>
                    ...
                    <div class="text-muted text-uppercase font-weight-bold small">Most Preorder</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body p-0 d-flex align-items-center">
                ...
                <div>
                    ...
                    <div class="text-muted text-uppercase font-weight-bold small">Least Preorder</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body p-0 d-flex align-items-center">
                ...
                <div>
                    ...
                    <div class="text-muted text-uppercase font-weight-bold small">Latest Preorder</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body p-0 d-flex align-items-center">
                ...
                <div>
                    ...
                    <div class="text-muted text-uppercase font-weight-bold small">Oldest Preorder</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="animated fadeIn">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-edit"></i>Pre-Order List
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><a class="btn btn-success" href="website.aspx?page=view_preorder&id=<%# Eval("uid")%>"><i class="fa fa-search-plus"></i></a></td>
                        </tr>
                    </ItemTemplate>
