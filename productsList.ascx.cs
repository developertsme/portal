...
public partial class components_productsList : System.Web.UI.UserControl
{
    ...
    {
        SqlCommand cmd = new SqlCommand("select top 100 * from t_products order by id desc");
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select top 100 * from t_products where name like '%'+@search+'%' order by id desc");
