<%@ Control Language="C#" AutoEventWireup="true" CodeFile="categoriesList.ascx.cs" Inherits="components_categoriesList" %>
    ...
    <div class="animated fadeIn">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-edit"></i>Categories List
            <div class="card-header-actions breadcrumb-menu">
                <a class="card-header-action label btn-sm btn-success" href="?page=new_category" target="_blank">
                    New Category
                </a>
            </div>
            </div>
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><a class="btn btn-success" href="website.aspx?page=view_categories&id=<%# Eval("uid")%>"><i class="fa fa-search-plus"></i></a></td>
                        </tr>
                    </ItemTemplate>
