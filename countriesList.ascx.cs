...
public partial class components_countriesList : System.Web.UI.UserControl
{
    ...
    {
        SqlCommand cmd = new SqlCommand("select top 100 * from t_countries order by id desc");
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select top 100 * from t_countries where name like '%'+@search+'%' order by id desc");
